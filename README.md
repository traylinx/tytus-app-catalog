...
|---|---|---|
| Atomek | `traylinx/tytus-app-atomek@v0.4.22/tytus-app.json` | Branded Tytus Resource Fabric cockpit, Monaco editor, intelligent chat, persistent workspace state, artifacts, AIL routing, embedded docs/skills, mission folders, OpenClaw/Hermes pods, local agents, shared folders, app skills, and approval-gated outputs. |
